...
"""
This file contains an implementation of the Stack data structure which uses a Linked List
"""
...
class Stack():
    """
    This code contains a Stack data-structure implementation based on the LinkedList class
    """
